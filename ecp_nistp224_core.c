 ...
 * marked with VERIFICATUM_NISTP224_OMITTED. (3) The end of the file
 * has been removed.
 */
...
#if 0 /* VERIFICATUM_NISP224_OMITTED */
...
#endif /* VERIFICATUM_NISP224_OMITTED */
                      ...
                      const felem z2)
{
    ...
    /* We have no use for this optimization */
#if 0 /* VERIFICATUM_NISP224_OMITTED */
    if (!mixed) {
#endif /* VERIFICATUM_NISP224_OMITTED */
        /* ftmp2 = z2^2 */
